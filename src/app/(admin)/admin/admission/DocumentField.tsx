 ...
 *
 * It differs from the `MediaField` twins in one substantive way: an admission
 * form is a **document**, not a picture. There is nothing to preview, the
 * ceiling is T-037's 10 MB PDF limit rather than the 5 MB image one, and the
 * required Bangla string is a description of the file rather than alt text for
 * an image — a screen reader announcing "admission form 2026" is describing a
