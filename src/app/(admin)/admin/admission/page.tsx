...
import { ADMISSION_COPY } from "@/app/(admin)/admin/admission/copy";
import { CyclePanel } from "@/app/(admin)/admin/admission/CyclePanel";
import { DocumentsPanel } from "@/app/(admin)/admin/admission/DocumentsPanel";
import { EligibilityPanel } from "@/app/(admin)/admin/admission/EligibilityPanel";
import { FaqsPanel } from "@/app/(admin)/admin/admission/FaqsPanel";
import { FeeGridPanel, FeeTypesPanel } from "@/app/(admin)/admin/admission/FeeGridPanel";
import { StepsPanel } from "@/app/(admin)/admin/admission/StepsPanel";
import type { Rights } from "@/app/(admin)/admin/admission/panel-kit";
