...
import { ACADEMICS_COPY } from "@/app/(admin)/admin/academics/copy";
import { AssignmentsPanel } from "@/app/(admin)/admin/academics/AssignmentsPanel";
import { CalendarPanel } from "@/app/(admin)/admin/academics/CalendarPanel";
import { ExamsPanel, ExamTermsPanel } from "@/app/(admin)/admin/academics/ExamsPanel";
import { GradesPanel } from "@/app/(admin)/admin/academics/GradesPanel";
import { InfoPanel } from "@/app/(admin)/admin/academics/InfoPanel";
import { RoutinesPanel } from "@/app/(admin)/admin/academics/RoutinesPanel";
import { SectionsPanel } from "@/app/(admin)/admin/academics/SectionsPanel";
import { SubjectsPanel } from "@/app/(admin)/admin/academics/SubjectsPanel";
import { YearsPanel } from "@/app/(admin)/admin/academics/YearsPanel";
import type { Rights } from "@/app/(admin)/admin/academics/panel-kit";
