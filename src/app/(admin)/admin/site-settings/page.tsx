...
import { BrandingPanel } from "@/app/(admin)/admin/site-settings/BrandingPanel";
import {
  ContactChannelsPanel,
  RegistrationIdsPanel,
  SocialLinksPanel,
} from "@/app/(admin)/admin/site-settings/ContactPanel";
import { SettingsPanel } from "@/app/(admin)/admin/site-settings/SettingsPanel";
import { SITE_SETTINGS_COPY } from "@/app/(admin)/admin/site-settings/copy";
import { StatsPanel } from "@/app/(admin)/admin/site-settings/StatsPanel";
