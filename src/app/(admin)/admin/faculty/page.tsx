...
import { FACULTY_COPY } from "@/app/(admin)/admin/faculty/copy";
import { FacultyPanel } from "@/app/(admin)/admin/faculty/FacultyPanel";
import type { Rights } from "@/app/(admin)/admin/faculty/panel-kit";
