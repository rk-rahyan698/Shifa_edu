...
import { InternalPanel } from "@/app/(admin)/admin/faculty/InternalPanel";
import { MediaField, type UploadedAsset } from "@/app/(admin)/admin/faculty/MediaField";
import {
  CheckboxGroup,
  EditorActions,
  ListRow,
  ...
  useActionRunner,
  type Rights,
} from "@/app/(admin)/admin/faculty/panel-kit";
import {
  deleteFacultyAction,
  saveFacultyAction,
  updateFacultyAction,
