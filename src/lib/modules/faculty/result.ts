/**
 * A Server Action's return value, for the `faculty` module.
 *
 * The sixth near-identical copy (`site-settings`, `home`, `about`, `academics`,
 * `admission`, and now this) — see `admission/result.ts` for why it stays a
 * copy rather than a shared import: M5 requires every module to be
...
export type ActionFailure = {
  ...
  /** Populated for a 422 only; `field` is the schema path, e.g. `values.sortOrder`. */
