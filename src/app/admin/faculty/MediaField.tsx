 ...
 * output is not revised. This is the sixth local twin (`site-settings`, `home`,
 * `about` x2, `academics`, `admission`, and now this) — see
 * `PENDING-COMMIT.md`'s B-3 note for the running count.
 *
 ...
 * variants and deduplication. Bangla alt text is required before a file is
 * offered — a teacher's photograph is a published image like any other.
 */
